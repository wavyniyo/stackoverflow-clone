...
const Tags = () => {
    ...
    const tagsList = [{
        id: 1,
        tagName: "javaScript",
        tagDesc: "For questions regarding programming in ECMAScript (JavaScript/JS) and its various dialects/implementations (excluding ActionScript). Please include all relevant tags on your questions ."
    },{
        id: 2,
        tagName: "python",
        tagDesc: "Python is a multi-paradigm, dynamically typed, multipurpose programmming language. It is designed to be quick to learn, understand, and use , and enforces a clean and uniform syntax."
    },{
        id: 3,
        tagName: "c#",
        ...
        id: 7,
        tagName: "android",
        tagDesc: "Android is Google's mobile operating sysytem, used for programming or developing digital devices (Smatphones. Tablets, Automobiles, TVs, Wear, Glass ,Iot)."
    },{
        id: 8,
        tagName: "css",
